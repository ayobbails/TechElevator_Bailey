  ...
  <div class="main">
    ...
    <div class="well-display">
      ...
      <div class="well">
        ...
        <!-- used here to provide condtional output               -->
        <!-- (if) ? (then) : (else)                               -->
    ...
    <!-- we are adding a click event to the link                    -->
    <a
      id="show-form-button"
      href="#"
...
export default {
  ...
  // computed: everytime data on the page changes
  computed: {
    averageRating() {
  ...
  methods: { // Run only when called - do not forgot the 's' on methods

    numberOfReviews(reviews, starType) {    // recieving the array and the rating (reviews, starType)
