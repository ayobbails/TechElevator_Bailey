...
export default {
  name: "product-review",
  // props is like parameters for a Java function: void function(<data-type> <parameter-name>)
  // 
  props: {                  // props contains properties whose values come from outside the component
    name: String,           // Specify data-type expected for the property (we do not know the default value 
    description: String,    //                                              because its being sent from outside the component)
    filterText: String
  },
  data() {                  // properties that are set and managed by this component
    return {
      showForm: false,      // Specify the default value for the property
      filter: 0,
      newReview: {},
      reviews: []
    };
