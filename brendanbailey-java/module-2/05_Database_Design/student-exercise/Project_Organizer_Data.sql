...
insert into project (name, start_date) values ('NewHorizonsDataV2', '2018-10-12');
insert into project (name, start_date) values ('DatabaseTransfertoCloud', '2020-01-19');
insert into project (name, start_date) values ('WeValueOurCustomers', '2001-11-24');      
