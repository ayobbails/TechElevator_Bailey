...
public class PlayingCard {
	...
	// a constructor to allow the user to specify the 
	// value, color, suit, face-up status when they instantiate it
	//      4-argument constructor - set the data members to the values passed in by the user
