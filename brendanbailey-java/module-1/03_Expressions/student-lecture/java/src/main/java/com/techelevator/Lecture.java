...
public class Lecture {
    ...
    */
    public boolean returnTrueFromIf() {
        ...
        // we only get to the below line of code if the if condition is false
        // referred to as "fall out of the if" when the condition is false
    ...
    */
    public boolean returnTrueWhenGreaterThanFive(int number) {
        if (number > 5) {
        	return true;  // end the function/method
        } else {
        	return false; // end the function
        }
       // return false; // number will never reach this point
    }
    ...
    */
    public String returnFizzOrBuzzOrNothing(int number) {
        ...
        // we get here only if the number is not 3 and not 5
        return "";
    }
