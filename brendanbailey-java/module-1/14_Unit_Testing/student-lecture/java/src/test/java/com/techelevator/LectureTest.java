...
public class LectureTest {	// Class to hold all our JUnit test
	...
	@Before
	public void setup() {	// method for anything to be done before each test is run
		System.out.println("setup");	//******THIS IS FOR ILLUSTRATION ONLY********
	}
	...
	public void teardown() {
		System.out.println("teardown");	//******THIS IS FOR ILLUSTRATION ONLY********
	}
	 ...
	 *
	 * method-names should be as descriptive as possible - don't worry about naming conventions
	 *
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		String theString = "Java"; 												// Arrange - setup up the data for the test
		int length = theString.length(); 										// Act 	   - perform the task you are testing
		Assert.assertEquals("String Java should be 4 characters", 4, length); 	// Assert  - check the result and report if failure
	}
