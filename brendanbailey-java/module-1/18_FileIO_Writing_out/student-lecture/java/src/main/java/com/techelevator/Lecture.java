...
public class Lecture {
	...
	public static void main(String[] args) throws IOException {
		...
		File newDirectory = new File(path);	// Create a File object to point to the directory we want
		...
		//	2. Use the same methods you used with System.out to write to the screen
		
		try (PrintWriter writer = new PrintWriter(newFile)) { // Define a PrintWriter object for my file
			writer.println(message);						  // Use the PrintWriter object and same methods as System.out to write to it
