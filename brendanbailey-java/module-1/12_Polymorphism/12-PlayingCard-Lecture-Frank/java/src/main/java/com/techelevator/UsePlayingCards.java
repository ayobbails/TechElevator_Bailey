...
public class UsePlayingCards {
	...
	// Without Polymorphism the class of the object invoking the method determines which method is run
...
//	PlayingCard aCard; 		// Define a super-class reference that right now points to nothing
