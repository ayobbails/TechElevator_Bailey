...
public class Exercises {
	...
	*/
	// int - code initialized once at the start of the loop
	// termination - tell the for loop when we exit, evaluates to "false"
	// increment/decrement - number or count incremented each time
	// 
	//	for(int i=0; i < 5; i ++) {
	//		 
	...
	// after the conditions have been declared to 
	// return true for 6 being either the first or last element in the array
	// how do I set the condition to return false?
	...
	/*
	 ...
	 makePi() → [3, 1, 4]
	 */
	// array type //// name of array //// tells Java its an array //// set equal to new for new array
	// int             arrayExample       []						   =new int[10];
																	//		number in brackets is how many elements in array
	public int[] makePi() {
	...
	/*
	 8. Given an array of ints length 3 [0, 1, 2], 
