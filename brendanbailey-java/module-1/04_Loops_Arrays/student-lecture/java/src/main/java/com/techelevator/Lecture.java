...
public class Lecture {
    ...
    */
	// datatype of return value is an int array
    ...
    */
    public int returnLastElement() {
        int[] portNumbers = { 80, 8080, 443 };
        return portNumbers[portNumbers.length-1]; // The highest valid index is the length -1
    }											  // The last element is at the index thats equal to the length -1
    											  // If we coded portNumbers[2] it would be tightly coupled
    /*
    ...
    */
    // Variables are only known and accessible within the block they are defined
