...
public class IntroToClassesCard {
	...
	public static void main(String[] args) {
        ...
        /*
         *  This application program will demonstrate several concepts presented in the Java Cohort
		 *  
        ...
        */
		...
		PlayingCard aCard = new PlayingCard();   // Instantiate a default PlayingCard Default (0-arg) ctor is run
		...
		PlayingCard theCard = new PlayingCard(8,"Spades","Green",true);   // Instantiate a new PlayingCard using the 4-arg ctor
		...
		PlayingCard myCard = new PlayingCard(1,"Spades");         // Instantiate a new PlayingCard using the 2-arg ctor
		...
		PlayingCard yourCard = new PlayingCard(14,"Diamonds");    // Instantiate a new PlayingCard with invalid value using the 2-arg ctor
        ...
        System.out.println("myCard's value is: " + myCard.getValue()); // Use the PlayingCard method to retrieve the card value in the object
